...
from checkers8.codebook import INPUT_VOCAB_SIZE, NUM_MOVES, MAX_SEQ_LEN


class CheckersTransformer(nn.Module):
    # Bumped capacity vs. the 4x4 model: 1024 possible moves and a much larger
    # position space make this a harder imitation target.
