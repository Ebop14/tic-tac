...
from checkers8free.codebook import INPUT_VOCAB_SIZE, NUM_MOVES, MAX_SEQ_LEN


class CheckersTransformer(nn.Module):
    # Same capacity as the forced-capture checkers8 model: 1024 possible moves
    # and a large position space make this a hard imitation target.
